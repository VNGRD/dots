...
COLOR_BATTERY_90='#88EE7A'         # Battery >= 90
COLOR_BATTERY_80='#C5EE7A'         # Battery >= 80
COLOR_BATTERY_70='#EEED7A'         # Battery >= 70
COLOR_BATTERY_60='#EECB7A'         # Battery >= 60
COLOR_BATTERY_50='#F2BC14'         # Battery >= 50
COLOR_BATTERY_LOW='#EE7A7B'        # Battery <  50
